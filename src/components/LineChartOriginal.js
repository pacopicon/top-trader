...
class LineChartOriginal extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    return (
      <div className="lineChartOriginal">
        ...
        <svg className="chart" width='100%' height='100%' viewBox={`0 0 ${fullWidth} ${fullHeight}`} style={svgStyle}>
          <TransitionGroup component="g">
            {/* TransitionGroup turns into a <span> component if you do not specify via the 'component' attribute that it should remain some other kind of component, 'g' in this case */}
...
export default LineChartOriginal
